...
function fugf.SelectFilter(_tp, _loc, _func, _val, _min, _max, ...)
	return fugf.GetFilter(_tp, _loc, _func, _val, ...):Select(_tp, _min or 1, _max or _min or 1, nil)
end
function fugf.SelectTg(_tp, _loc, _func, _val, _min, _max, ...)
	local g = fugf.SelectFilter(_tp, _loc, _func, _val, _min, _max, ...)
